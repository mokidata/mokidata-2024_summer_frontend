...
function CompPredictSales(props) {
  ...
  useEffect(() => {
    try {
      const predictValue = props.predictvalue[props.page]["today"];
  ...
  useEffect(() => {
    setChartData([
      {
        column: props.t("compPredictSales.expectedRevenue"),
        value: predictTotal,
        highlight: false,
        valueHighlight: false,
      },
      {
        column: props.t("compPredictSales.actualRevenue"),
        value: todayTotal,
        highlight: true,
        valueHighlight: true,
      },
        ...
        <div className="report-title">
          <div>
            {props.page === "daily"
              ...
              : props.page === "weekly"
              ? props.t("compPredictSales.thisWeekSales")
              : props.page === "monthly"
              ? props.t("compPredictSales.thisMonthSales")
              : props.t("compPredictSales.todaySales")}{" "}
            😆
          </div>
          <div
